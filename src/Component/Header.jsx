  ...
  return (
    <div className='md:flex justify-center items-center '>
      ...
      <div className='md:flex md:gap-12 md:mt-8 md:ml-20'>
         ...
         <div>
            <img src='https://img.freepik.com/free-psd/3d-illustration-person-with-sunglasses_23-2149436188.jpg?w=740&t=st=1702343609~exp=1702344209~hmac=35ba3b139f94212d9dfe5ce11a5014167edda673f480b84df352dec65d603755' className='rounded-full w-[5    0px] items-end' />
         </div>
      </div>
    </div>
  )
